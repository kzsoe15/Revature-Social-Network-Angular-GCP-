...
export class ProfileComponent implements OnInit {
  ...
  /**
   * call getUserById method from profileService 
   */
  getChosenUser() {
  ...
  */
  ...
  /**
   * open EditProfileComponent modal
   */
  editProfile() {
  ...
  /**
   * call get userByName form user search service and save their data in currentuser
   */
  searchForUser() {
