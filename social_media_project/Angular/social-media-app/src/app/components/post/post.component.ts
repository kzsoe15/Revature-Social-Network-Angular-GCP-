...
export class PostComponent implements OnInit {
  ...
  // calls post service and hide user info
  getPostsFromService() {
    this.postsFromService();
    this.showUserInfo = false;
  }

  // get current user form current user service
  getCurrentUser() {
  ...
  // call populatPostList method and pass in the getAllPost method as an argument
  postsFromService() {
  ...
  /**
   * create post and call addPost method from post service
   * @return early if user's post doe not have any content
   */
  createPost() {
    this.showUserInfo = false;
    let newPost = new Post();
 ...
 * @param eve  = event triggered by user upload
 */
  ...
  /**
   * increment likes in post and call likePost method from post service
   * @param post 
   */
  likePost(post: Post) {
