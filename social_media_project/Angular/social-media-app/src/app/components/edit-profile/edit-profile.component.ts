...
export class EditProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // initalized by the current logged in user
    this.editUser = this.currUserServ.currUser
  }

  /**
   * confirm new password matches the confirm new password
   */
  confirmChanges() {
  ...
  /**
   * update user information calls userservice to send a request to the backend 
