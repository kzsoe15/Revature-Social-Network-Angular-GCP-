...
export class LoginComponent implements OnInit {
  ...
  /**
   * calls loginRequest method form loginService to 
  ...
  validate(): void {
    ...
    this.loginService.loginRequest(this.login_username, this.login_password).subscribe(
      data => {
        ...
        // pop alert if credientials are false
  ...
  /**
   * open a modal that contains the RegisterComponent
   */
  register() {
  ...
  /**
   * calls error method from alertService to display message 
