...
export class NewPostComponent implements OnInit {
  ...
  /**
   * create new post by calling addPost method from post service 
   */
  createPost() {
    this.showUserInfo = false;
    let newPost = new Post();
    // get currentUser from CurUserService
  ...
  /**
   * set selectFile that user upload 
   * @param eve = event triggered by user when uploading file
   */
